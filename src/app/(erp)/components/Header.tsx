...
export default function Header() {
  ...
  return (
    <header className="flex items-center justify-between py-4 gap-6">
      ...
      <div className="flex-1 flex justify-start pl-0 sm:pl-16 md:pl-10 lg:pl-0">
        ...
        <div className="w-16 h-12 flex items-center justify-center bg-primary-50 drop-shadow rounded-2xl">
          {currentIcon}
        </div>
        {/* Title (Only takes necessary width) */}
        <div className="flex px-4 py-2 bg-primary-50 items-center justify-center drop-shadow rounded-2xl">
